 ...
 */
export function findEventsResource(params: Signal<FindEventsParams> | undefined,
  options: OrvalHttpResourceOptions<EventLookup[], unknown> & { defaultValue: NoInfer<EventLookup[]> }): HttpResourceRef<EventLookup[]>;
export function findEventsResource(params?: Signal<FindEventsParams>,
  options?: OrvalHttpResourceOptions<EventLookup[], unknown>): HttpResourceRef<EventLookup[] | undefined>;
export function findEventsResource(params?: Signal<FindEventsParams>,
  options?: OrvalHttpResourceOptions<EventLookup[], unknown>): HttpResourceRef<EventLookup[] | undefined> {
  return httpResource<EventLookup[]>(() => {
...
export type FindEventsResourceResult = NonNullable<EventLookup[]>
