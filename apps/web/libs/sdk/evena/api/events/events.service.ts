...
/**
 * Finds public events or user-owned events
 * @summary Find Events
 */
 findEvents<TData = EventLookup[]>(params?: FindEventsParams, options?: HttpClientBodyOptions): Observable<TData>;
 findEvents<TData = EventLookup[]>(params?: FindEventsParams, options?: HttpClientEventOptions): Observable<HttpEvent<TData>>;
 findEvents<TData = EventLookup[]>(params?: FindEventsParams, options?: HttpClientResponseOptions): Observable<AngularHttpResponse<TData>>;
  findEvents<TData = EventLookup[]>(
    params?: FindEventsParams, options?: HttpClientObserveOptions): Observable<TData | HttpEvent<TData> | AngularHttpResponse<TData>> {
...
export type FindEventsClientResult = NonNullable<EventLookup[]>
